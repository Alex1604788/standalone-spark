-- =====================================================
-- ПРИМЕНИТЬ МИГРАЦИИ ДЛЯ АГРЕГАЦИИ ДАННЫХ ПО КАМПАНИЯМ
-- =====================================================
-- Скопируйте и выполните этот SQL в Supabase SQL Editor
-- Это решит проблему с лимитом 1000 записей
-- =====================================================

-- МИГРАЦИЯ 1: Функция для агрегации кампаний
-- =====================================================
...
-- МИГРАЦИЯ 2: Функция для товаров в кампании
-- =====================================================
...
-- ГОТОВО!
-- =====================================================
-- Теперь React-компонент будет использовать эти функции
-- вместо загрузки всех сырых данных
-- =====================================================
